...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 14 12:30:31 2017
...
with graph.as_default():
    ...
    drop_layer = tf.nn.dropout(logits_1, keep_prob)
    logits_2 = tf.matmul(drop_layer, weights2) + biases2
    # Softmax loss
    ...
    base_lr = 0.5  # Learning rate
    # Learning Rate Decay
    global_step = tf.Variable(0)  # Num of steps taken
    lr = tf.train.exponential_decay(base_lr, global_step,
